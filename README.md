...
**GitHub repo configured:** `tgynl/vpn-installations` (create this repo before distributing anything).
...
1. **Create the GitHub repo** `tgynl/vpn-installations` (public is simplest -
